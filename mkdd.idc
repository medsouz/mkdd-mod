...
static main () {
	...
	SetFunctionCmt(0x80003540, "r3 = destination\nr4 = source\nr5 = size", 0);
	...
	MakeComm(0x800174bc, "80017D28");
	MakeName(0x80017d28, "LoadBLO_SectionHeader");
	MakeComm(0x80017d28, "Move the stack pointer back 10");
	SetFunctionCmt(0x80017d28, "Copy BLO section header to memory\nBranched to from 80017498\n\n\nr3 = Address of a structure:\n    struct unk {\n        0x8 = File location\n        0xC = File size\n        0x10 = Section offset from start of file\n    }\nr4 = Where to load the BLO section header\nr5 = Section header size", 0);
	MakeComm(0x80017d30, "Write link register to the stack");
	MakeComm(0x80017d34, "Write r30 to the stack");
	MakeComm(0x80017d40, "Read section offset");
	MakeComm(0x80017d44, "Read file size");
	MakeComm(0x80017d4c, "Make sure sectionStart + sectionHeaderSize isn't larger than the file size");
	MakeComm(0x80017d58, "If the file is empty skip over memcpy");
	MakeComm(0x80017d60, "Get file location");
	MakeComm(0x80017d64, "Destination");
	MakeComm(0x80017d68, "Section Size");
	MakeComm(0x80017d6c, "Section Position");
	MakeComm(0x80017d84, "Restore r30");
	MakeComm(0x80017d88, "Restore link register");
	MakeComm(0x80017d90, "Restore the stack pointer");
	...
	MakeName(0x80030170, "LoadBLO");
	SetFunctionCmt(0x80030170, "r4 = BLO file name\nr6 = Pointer to 8033E030", 0);
	MakeComm(0x800301ac, "r3 was r6 at the start of the function");
	MakeComm(0x800301b8, "80015ea8");
	MakeComm(0x80047bd4, "80041c68");
	MakeComm(0x80047c68, "Branched to at 8016BE98");
	MakeComm(0x80047ca0, "80047b2c");
	...
	MakeComm(0x80162508, "Runs when the left and right triggers are pressed for \"random\"");
	...
	MakeComm(0x801625b4, "If the current player ID doesn't match the driver ID then move to check the passenger");
	...
	MakeComm(0x8016260c, "Update cursor position");
	MakeComm(0x80162618, "Set cursor position to 0xFFFFFFFF");
	MakeName(0x80162ae4, "CharacterSelectAPressed");
	MakeComm(0x80162b78, "Driver ID");
	MakeComm(0x80162b80, "If the driver is already set then skip over this section");
	MakeComm(0x80162b98, "Set the driver ID");
	MakeComm(0x80162be8, "Passenger ID");
	MakeComm(0x80162bf0, "If the passenger is already set skip over this section");
	MakeComm(0x80162c08, "Set the passenger ID");
	MakeName(0x80162cc0, "CharacterSelectBPressed");
	...
	MakeComm(0x80163158, "Get team state");
	MakeComm(0x80163160, "Picking kart");
	MakeComm(0x80163168, "Picking characters");
	MakeName(0x80163178, "ChangeCharacterRight");
	MakeName(0x801631a0, "ChangeKartRight");
	...
	MakeComm(0x80163a7c, "Check unlockable characters");
	...
	MakeComm(0x8016b750, "Seems to always be 80047f68");
	MakeComm(0x8016bad8, "Seems to always be 80031ac0");
	MakeComm(0x8016bc1c, "This section handles loading the highest rank (bronze cup, silver cup, gold cup) that the player has won for each cup");
	MakeName(0x8016bd68, "LoadCupFrame");
	SetFunctionCmt(0x8016bd68, "Runs whenever a different cup is selected", 0);
	MakeComm(0x8016bda4, "Seems to always be 80047c68");
	...
	SetFunctionCmt(0x801db840, "Something to do with save data", 0);
	...
	MakeName(0x8034b7d4, "SelCourse_bti");
